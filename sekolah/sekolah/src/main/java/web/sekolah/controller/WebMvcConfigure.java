...
public class WebMvcConfigure implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/img/guru/**")
                .addResourceLocations("file:C:/SpringBoot-TA/sekolah/sekolah/src/main/resources/static/img/guru/")
        ...
        registry.addResourceHandler("/img/ekstrakurikuler/**")
                .addResourceLocations("file:C:/SpringBoot-TA/sekolah/sekolah/src/main/resources/static/img/ekstrakurikuler/")
                .setCachePeriod(0); // Cache di-disable agar gambar langsung terupdate
        ...
        registry.addResourceHandler("/img/prestasi-guru/**")
                .addResourceLocations("file:C:/SpringBoot-TA/sekolah/sekolah/src/main/resources/static/img/prestasi-guru/")
                .setCachePeriod(0); // Cache di-disable agar gambar langsung terupdate
        ...
        registry.addResourceHandler("/img/prestasi-siswa/**")
                .addResourceLocations("file:C:/SpringBoot-TA/sekolah/sekolah/src/main/resources/static/img/prestasi-siswa/")
                .setCachePeriod(0);

        registry.addResourceHandler("/img/prestasi-sekolah/**")
                .addResourceLocations("file:C:/SpringBoot-TA/sekolah/sekolah/src/main/resources/static/img/prestasi-sekolah/")
                .setCachePeriod(0);
