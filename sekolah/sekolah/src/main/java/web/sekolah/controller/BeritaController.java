...
public class BeritaController {
    ...
    // ✅ Path upload dinamis
    private static final String UPLOAD_DIR = Paths.get("C:/Users/Nur Fitri Amalia/TA-Project/sekolah/sekolah/src/main/resources/static/img/berita").toAbsolutePath().toString();
